    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        <div class="m-subheader ">
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    <h3 class="m-subheader__title m-subheader__title--separator">List Reputation</h3>
                </div>
                <div>
                    ...
                    <table class="m-datatable" id="html_table" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th title="Field #2">Target_id</th>
                                <th title="Field #3">type</th>
                                <th title="Field #4">Point</th>
                                <th title="Field #5">User_id</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td>
                                    <a href="admin/reputation/edit" class="btn btn-info"><i class="fa fa-edit"></i></a>
