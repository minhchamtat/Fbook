    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        <div class="m-subheader ">
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    <h3 class="m-subheader__title m-subheader__title--separator">{{ __('admin.listBook') }}</h3>
                </div>
            </div>
        </div>
            ...
            <div class="m-portlet m-portlet--mobile">
                ...
                <div class="m-portlet__body">
                    <table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_1">
                        <thead>
                            <tr>
                                <th title="Title">{{ __('admin.titleBook') }}</th>
                                <th title="Author">{{ __('admin.author') }}</th>
                                <th title="Publist date">{{ __('admin.publish') }}</th>
                                <th title="Total Page">{{ __('admin.totalPage') }}</th>
                                <th title="Avg star">{{ __('admin.avgStar') }}</th>
                                <th title="View">{{ __('admin.view') }}</th>
