                    ...
                    <table class="m-datatable" id="html_table" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th title="Field #6">Posision</th>
                                <th title="Field #7">Role</th>
                                <th title="Field #8">Reputation_poi</th>
                                <th title="Field #9">Employee_cod</th>
                                <th title="Field #10">Workspace</th>
                                <th title="Field #11">Office_Id</th>
                                <th title="Field #12">ChatWork_Id</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td>
                                    <a href="admin/user/edit" class="btn btn-info"><i class="fa fa-edit"></i></a>
                                    <a href="" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                </td>
                                <td>1</td>
                                <td>Cristiano Rodaldo</td>
